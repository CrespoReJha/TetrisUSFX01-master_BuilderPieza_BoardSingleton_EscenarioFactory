...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEscenario_Statics::NewProp_EscenarioMesh_MetaData[] = {
		{ "Category", "Escenario" },
		{ "Comment", "//FString GetNombreEscenario();\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Escenario.h" },
		{ "ToolTip", "FString GetNombreEscenario();" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEscenario_Statics::NewProp_EscenarioMesh = { "EscenarioMesh", nullptr, (EPropertyFlags)0x0010000000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEscenario, EscenarioMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AEscenario_Statics::NewProp_EscenarioMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEscenario_Statics::NewProp_EscenarioMesh_MetaData)) };
	...
	IMPLEMENT_CLASS(AEscenario, 14153814);
