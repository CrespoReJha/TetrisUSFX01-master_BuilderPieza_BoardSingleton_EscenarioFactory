...
#include "ConstructorPiezaGrande.generated.h"

UCLASS()
class TETRISUSFX01_API AConstructorPiezaGrande : public AActor, public IConstructorPiezas
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AConstructorPiezaGrande();
