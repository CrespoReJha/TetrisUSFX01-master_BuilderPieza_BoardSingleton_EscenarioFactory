...
#include "ConstructorPiezaTetromino.generated.h"

UCLASS()
class TETRISUSFX01_API AConstructorPiezaTetromino : public AActor, public IConstructorPiezas
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AConstructorPiezaTetromino();
